...
async def update_progress(user_id: str, update: ProgressUpdate) -> dict:
    """
    ...
    if existing:
        ...
        _progress_store[user_id].append({
    ...
    return {"status": "success", "message": "Progress recorded in the Chronicle"}
